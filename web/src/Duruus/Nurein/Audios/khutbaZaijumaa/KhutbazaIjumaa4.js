...
import { khutbazaijumaadata } from './Data';

const BASE_URL = 'https://www.deenkhaalis.com/'; // replace with your actual base URL
const KhutbazaIjumaa4 = () => {
    const [isplaying, setisplaying] = useState(false);
    const [currentSong, setCurrentSong] = useState(khutbazaijumaadata[0]);
    const [songs, setSongs] = useState(khutbazaijumaadata);
    const onPlaying = () => {
        ...
        <div className=''>
            <div className=' flex-col flex-grow overflow-y-auto'>
                <div className=" py-7 px-8 mt-20 cursor-pointer mb-4">
                    ...
                    <p className='text-center'>Hizi ni Khutwab za Ijumaa  Zilizotolewa na sheikh wetu Abu Uthmaan Nurein</p><br />
                    {songs.map((song, index) => (
                        <div className='' key={index} onClick={() => selectSong(song)}>
