...
import { abuwaldyadata } from './Data';

const BASE_URL = 'https://www.deenkhaalis.com'; // replace with your actual base URL
const AbuWalidy4 = () => {
    const [isplaying, setisplaying] = useState(false);
    const [currentSong, setCurrentSong] = useState(abuwaldyadata[0]);
    const [songs, setSongs] = useState(abuwaldyadata);
    const onPlaying = () => {
        ...
        <div className=''>
            <div className=' flex-col flex-grow overflow-y-auto'>
                ...
                <h2 className='text-center  text-2xl font-bold mb-5'>بِسۡمِ ٱللَّهِ ٱلرَّحۡمَٰنِ ٱلرَّحِيم</h2>
                    <p className='text-center'>Huu ni Wasiya wa Imaam Abu Walidy Al-Baajy kwa wanawe, uliofundishwa na sheikh wetu Abu Uthmaan Nurein, Al-Jabarty</p><br />
             ...
             bg-black text-white'>
                ...
                <div className="navigation w-full mb-4">
                    <div className="navigation_wrapper" onClick={checkWidth} ref={clickRef}>
                        <div className="seek_bar" style={{ width: `${currentSong.progress + "%"}` }}>
