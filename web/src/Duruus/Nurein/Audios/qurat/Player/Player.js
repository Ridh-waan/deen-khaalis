        ...
        <div className=''>
            <div className=' flex-col flex-grow overflow-y-auto'>
                ...
                <h2 className='text-center  text-2xl font-bold mb-5'>بِسۡمِ ٱللَّهِ ٱلرَّحۡمَٰنِ ٱلرَّحِيم</h2>
                    <p className='text-center'>Hizi ni sauti za kitabu Quratul Uyuunil Muwahideen sharhe ya Kitabu Tawheed chake Abdurahmaan Bin Hassan ambaye ni mjukuu wa mtunzi wa kitabu kilichofundishwa na sheikh wetu Abu Uthmaan Nurein, Al-Jabarty</p><br />
