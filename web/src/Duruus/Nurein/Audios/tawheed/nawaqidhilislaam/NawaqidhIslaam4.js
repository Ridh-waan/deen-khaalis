...
import { nawadhislamdata } from './Data';

const BASE_URL = 'https://www.deenkhaalis.com/'; // replace with your actual base URL
const NawaqdhIslaam4 = () => {
    const [isplaying, setisplaying] = useState(false);
    const [currentSong, setCurrentSong] = useState(nawadhislamdata[0]);
    const [songs, setSongs] = useState(nawadhislamdata);
    const onPlaying = () => {
            ...
            <div className=' flex-col flex-grow overflow-y-auto'>
                <div className=" py-7 px-8 mt-20 cursor-pointer mb-4">
                    ...
                    <p className='text-center'>Hizi ni sauti za matni Nawaqidhil Islaam cha Imamul Mujadid
                        ...
                        inayopatikana katika juzuu nne ambazo kwamba zinaifadhishwa katika Masjid Nnabawi
                        na wengi miongoni mwa wanafunzi wameziifadhi zilizotolewa na sheikh wetu Abu Uthmaan Nurein Al-Jabarty</p><br />
                    {songs.map((song, index) => (
                        <div className='py-16' key={index} onClick={() => selectSong(song)}>
