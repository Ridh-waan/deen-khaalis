...
import { qiswarusuwardata } from './Data';

const BASE_URL = 'https://www.deenkhaalis.com/'; // replace with your actual base URL
const QiswaruSuwar3 = () => {
    const [isplaying, setisplaying] = useState(false);
    const [currentSong, setCurrentSong] = useState(qiswarusuwardata[0]);
    const [songs, setSongs] = useState(qiswarusuwardata);
    const onPlaying = () => {
