    ...
    return (
        <div className=''>
            <div className=' flex-col flex-grow overflow-y-auto'>
                ...
                <p className='text-center'>Hizi ni sauti za kitaby Manhaj Salikeen chake Sheikh Abdurahmaan Ibn Naasir Assiydi  kilichofundishwa na sheikh wetu Abu Issa Muhammad
                    Issa </p><br />
