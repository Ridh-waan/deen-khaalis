...
import { majmuudata } from './Data';

const BASE_URL = 'https://www.deenkhaalis.com/'; // replace with your actual base URL
const MajmuuFatwa3 = () => {
    const [isplaying, setisplaying] = useState(false);
    const [currentSong, setCurrentSong] = useState(majmuudata[0]);
    const [songs, setSongs] = useState(majmuudata);
    const onPlaying = () => {
        ...
        <div className=''>
            <div className=' flex-col flex-grow overflow-y-auto'>
                ...
                <h2 className='text-center  text-2xl font-bold mb-5'>بِسۡمِ ٱللَّهِ ٱلرَّحۡمَٰنِ ٱلرَّحِيم</h2>
                    <p className='text-center'>Hizi ni sauti za kitabu Majmuu fatawa wa makalaat cha Sheikh
                        Abdullah Ibn Abdulaziiz Ibn Baaz
