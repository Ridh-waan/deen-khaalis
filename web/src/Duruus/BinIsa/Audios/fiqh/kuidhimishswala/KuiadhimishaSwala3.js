...
import { kuiadhimishaswaladat } from './Data';

const BASE_URL = 'https://www.deenkhaalis.com/'; // replace with your actual base URL
const KuiadhimishaSwala3 = () => {
    const [isplaying, setisplaying] = useState(false);
    const [currentSong, setCurrentSong] = useState(kuiadhimishaswaladat[0]);
    const [songs, setSongs] = useState(kuiadhimishaswaladat);
    const onPlaying = () => {
...
export default KuiadhimishaSwala3;
