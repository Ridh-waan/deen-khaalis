...
import { kuiadhimishaswaladata } from './Data.js';
import '../../../../../App.css'

const Hakami2021 = () => {
  const [isplaying, setisplaying] = useState(false);
  const [currentSong, setCurrentSong] = useState(kuiadhimishaswaladata[0]);
  const [songs, setSongs] = useState(kuiadhimishaswaladata);
