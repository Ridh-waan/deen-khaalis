...
import { qaraawi2021data } from './Data.js';
import '../../../../../App.css'
const Qaraawi2021 = () => {
  const [isplaying, setisplaying] = useState(false);
  const [currentSong, setCurrentSong] = useState(qaraawi2021data[0]);
  const [songs, setSongs] = useState(qaraawi2021data);
