        ...
        <div className=''>
            <div className=' flex-col flex-grow overflow-y-auto'>
                ...
                <h2 className='text-center  text-2xl font-bold mb-5'>بِسۡمِ ٱللَّهِ ٱلرَّحۡمَٰنِ ٱلرَّحِيم</h2>
                    <p className='text-center'>Hizi ni sauti za kitabu Al Kifaya kilichofundishwa na sheikh wetu Abu Issa Muhammad
                    Issa siku ya Daura ya sita ya Sheikh Abdallah Al-Qaraawi, Masjid Maryam, Kisauni.</p><br />
