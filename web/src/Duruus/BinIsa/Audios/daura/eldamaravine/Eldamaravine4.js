...
import { eldamaravinedata } from './Data.js';
import '../../../../../App.css'
const Eldamaravine3 = () => {
  const [isplaying, setisplaying] = useState(false);
  const [currentSong, setCurrentSong] = useState(eldamaravinedata[0]);
  const [songs, setSongs] = useState(eldamaravinedata);
