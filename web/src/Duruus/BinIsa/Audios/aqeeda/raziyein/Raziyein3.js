...
import { raziyeindata } from './Data';

const BASE_URL = 'https://www.deenkhaalis.com/'; // replace with your actual base URL
const Raziyein3 = () => {
    const [isplaying, setisplaying] = useState(false);
    const [currentSong, setCurrentSong] = useState(raziyeindata[0]);
    const [songs, setSongs] = useState(raziyeindata);
    const onPlaying = () => {
