...
import { Wajibuna3data } from './Data.js';
import '../../../../../App.css'
const Wajibuna3 = () => {
  const [isplaying, setisplaying] = useState(false);
  const [currentSong, setCurrentSong] = useState(Wajibuna3data[0]);
  const [songs, setSongs] = useState(Wajibuna3data);
