    ...
    return (
        <div className=''>
            <div className=' flex-col flex-grow overflow-y-auto'>
                ...
                <p className='text-center'>Hizi ni sauti za kitaabu Usulu Sittah chake Sheikh Muhammad bin Abdaulwahaab, kilichofundishwa na sheikh wetu Abu Issa Muhammad
                    Issa </p><br />
