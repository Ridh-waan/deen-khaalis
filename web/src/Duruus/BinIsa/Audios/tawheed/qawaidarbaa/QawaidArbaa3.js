...
import { QawaidArbaa3data } from './Data.js';
import '../../../../../App.css'
const QawaidArbaa3 = () => {
  const [isplaying, setisplaying] = useState(false);
  const [currentSong, setCurrentSong] = useState(QawaidArbaa3data[0]);
  const [songs, setSongs] = useState(QawaidArbaa3data);
