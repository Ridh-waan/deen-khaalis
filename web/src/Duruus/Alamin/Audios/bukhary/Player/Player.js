    ...
    return (
        <div className=''>
            <div className=' flex-col flex-grow overflow-y-auto'>
                ...
                <p className='text-center'>Hizi ni sauti ya kitabul i'itiswaam bil kitabi wa Sunnah
                kilichotolewa katika Sahiih Bukhary  yake 
                Imaam Al Bukhary kilichofundishwa na sheikh wetu Abu Ibraheem Al-amiin Said 
                    siku ya Dawra ya tatu ya Sheikh Haafidh Al Hakamy</p><br />                  
