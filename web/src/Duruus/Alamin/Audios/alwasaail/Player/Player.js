    ...
    return (
        <div className=''>
            <div className=' flex-col flex-grow overflow-y-auto'>
                ...
                <p className='text-center'>Hizi ni sauti za kitabu Al Wasaail Mufiidah chake Sheikh Abbdurahmaan Naasir Assiydi mmoja miongoni mwa mashekhe wa Qaswiim  kilichofundishwa na sheikh wetu
                 Abu Ibrahiim Alamin Saeed </p><br />
