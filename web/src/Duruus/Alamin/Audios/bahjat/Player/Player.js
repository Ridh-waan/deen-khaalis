    ...
    return (
        <div className=''>
            <div className=' flex-col flex-grow overflow-y-auto'>
                ...
                <p className='text-center'>Hizi ni sauti ya sherehe ya kitabu Bahjat Qulubul Abraar chake 
                sheikh Abdurahmaan Naasir Assiyd kilichofundishwa na sheikh wetu Abu Ibraheem Al-amiin Said 
                    siku ya Dawra ya sita ya Sheikh Haafidh Al Hakamy</p><br />                  
