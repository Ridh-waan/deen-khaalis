    ...
    return (
        <div className=''>
            <div className=' flex-col flex-grow overflow-y-auto'>
                ...
                <p className='text-center'>Hizi ni sauti za kitau Aqeedatu Tawheed  chake Sheikh 
                Swaaleh Al Fawzany
                 kilichofundishwa na sheikh wetu Abu Ibraheem Al-amiin Said 
                    siku za Dawra ya Sheikh Abdallah Al Qaraawi, Masjid Mariam Kisauni</p><br />                  
