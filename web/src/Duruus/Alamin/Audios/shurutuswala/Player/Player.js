        ...
        <div className=''>
            <div className=' flex-col flex-grow overflow-y-auto'>
                ...
                <h2 className='text-center  text-2xl font-bold mb-5'>بِسۡمِ ٱللَّهِ ٱلرَّحۡمَٰنِ ٱلرَّحِيم</h2>
                    <p className='text-center'>Hizi ni sauti za kitabu Shuruutu swalah wa Arkanuha wa Wajibatuha
                    chake Imamul Mujadid, Muhammad Ibn Abdilwahaab
                    zilizotolewa na sheikh wetu Abu Ibraheem Al-amiin Said </p><br />
