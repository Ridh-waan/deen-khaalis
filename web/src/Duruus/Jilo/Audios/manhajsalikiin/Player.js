        ...
        <div className=''>
            <div className=' flex-col flex-grow overflow-y-auto'>
                ...
                <h2 className='text-center  text-2xl font-bold mb-5'>بِسۡمِ ٱللَّهِ ٱلرَّحۡمَٰنِ ٱلرَّحِيم</h2>
                    <p className='text-center'>Hii ni sauti za kitabu Manhaj Salikeen chake Sheikh Abdurahmaan Ibn Naasir Asiidy
                    zilizofundishwa na sheikh wetu Abu Feiswal Uthmaan Jilo siku ya sita ya Sheikh Al Haafidh Al Hakamy
                    </p><br />
