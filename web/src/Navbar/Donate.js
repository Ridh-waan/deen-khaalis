  ...
  return (
    <div className='section' id='Donate'>
      ...
      <div className='pl-5'>
          ...
          {/* <div className='sm:text-3xl text-2xl font-bold mb-2'> */}
            Ndugu zetu  <span className='text-lime-500'>wapenda heri</span><br/>  
          </div>
...
<br/>
 <br/>
Sheikh ibnu Baaz na Ulamaa wengineo wamesema: "Na kila aliyechangia katika kuitoa elimu hii 
yenye manufaa atapata thawabu hii adhimu", [Allajnatu ddaaimah 11/17].
  ...
  <button className='py-3 px-4 bg-lime-500 rounded-lg text-sm font-bold'>
     <a href='https://www.mchanga.africa/fundraiser/96144' target="_blank">Donate Now</a>  
          </button>
        </div>
